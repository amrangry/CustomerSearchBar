//
//  UISearchBar+ExtensionHelper.swift
//  Rayhan
//
...
extension UISearchBar {
    ...
    func setTextFieldClearButtonText(txt: String) {
        
        
        
        let uiButton = self.value(forKey: "cancelButton") as! UIButton
         uiButton.setTitle(txt, for: UIControlState.normal)
